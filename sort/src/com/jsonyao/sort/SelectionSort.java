 ...
 * Relation:
 *      a. https://baike.baidu.com/item/%E9%80%89%E6%8B%A9%E6%8E%92%E5%BA%8F/9762418?fr=aladdin
...
public class SelectionSort {
    ...
    public void selectionSort(int[] arr){
        /**
         * A. 核心思想:
         *      a. 顺序遍历数组, 如找到比当前元素更小的元素, 与当前位置交换, 直至比较到数组倒数第二个元素, 因此最后一个元素要么就最大, 要么就被交换过, 这时整个数组有序
         * B. 时间复杂度:
         ...
         * D. 算法分析:
         *      a. 选择排序是"最稳定"的排序算法之一, 因为无论什么数据进去都是O(n^2)的时间复杂度, 但该算法是不稳定的, 因为相等元素相对位置可能会发生变化
         *      b. 所以用它的时候, 数据规模越小越好
